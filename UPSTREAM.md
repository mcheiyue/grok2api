...
| 本地 tip（含改造） | merge upstream **`6463c6a3`**（v3.1.4+64：#1003 Console stale-quota reconcile、statsig refresh、auth cookie fallback、doom-loop split thresholds、SuperGrok Plus billing 等 + **保留 Console team 熔断**） |
