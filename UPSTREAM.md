...
| 本地 tip（含改造） | merge upstream **`8913b53f`**（v3.1.5+22：multi-turn reasoning replay + reasoning cache、root union schema 展平、CLI tool_choice 空工具修复、manual route 兼容别名、account cooldown cap Retry-After、Codex view_image 别名） |
